...
console.log(logo,name,rating,deal,"null caming");
  ...
  const similarStores = [
    "Paytm Bus Coupons", "Flipkart Coupons", "Abibus Coupons", 
    "IndiGo Coupons", "Air Arabia Coupons", "Myntra", "Amazon", 
    "Dominos", "Flipkart"
  ];
  ...
  const faqData = [
    {
      ...
      answer: "Simply copy the coupon code and apply it during checkout on the Boat Ed website. The discount will be automatically applied to your purchase."
    },
    {
      question: "Are these coupon codes verified?",
      answer: "Yes, all our coupon codes are regularly tested and verified to ensure they work properly. We update them frequently to provide the best deals."
    },
    {
      question: "Do Boat Ed coupons expire?",
      answer: "Yes, most coupon codes have an expiration date. We recommend using them as soon as possible to avoid missing out on great deals."
    },
    {
      question: "Can I combine multiple coupons?",
      answer: "Typically, only one coupon can be used per purchase. However, some promotions may allow stacking with other offers. Check the terms and conditions for details."
    },
    {
      question: "What if my coupon code doesn't work?",
      answer: "If a coupon code doesn't work, it may have expired or reached its usage limit. Try another code from our list or contact Boat Ed customer support for assistance."
    }
  ];
      ...
      <div className='flex flex-col lg:flex-row p-6 gap-6 max-w-7xl mx-auto'>
        ...
        <div className='lg:w-1/3 space-y-6'>
          ...
          <div className='bg-white/80 backdrop-blur-sm shadow-xl rounded-2xl border border-white/20 p-6'>
            <h1 className='text-xl font-bold text-gray-800 mb-4'>Trending {storeName} Coupon Codes & Offers</h1>
            ...
            <div className='bg-blue-50 rounded-xl p-4 mb-4'>
              <h2 className='text-center font-bold text-lg text-gray-800 mb-3'>Today's {storeName} Top Offers</h2>
              <div className='flex justify-between text-center'>
                ...
                <div>
                  ...
                  <p className='text-2xl font-bold text-green-600'>{coupons.filter(c => c.type === 'code').length}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Shopping Tips */}
          <div className='bg-white/80 backdrop-blur-sm shadow-xl rounded-2xl border border-white/20 p-6'>
            <h1 className='text-xl font-bold text-center text-gray-800 mb-4'>Boating Shopping Tips</h1>
            <div className='space-y-4'>
              <div>
                <h2 className='font-bold text-gray-800 mb-2'>Newsletter Subscriptions</h2>
                <p className='text-gray-600 text-sm'>Subscribe to the {storeName} newsletter to receive email notifications about special deals and discounts on boating courses and licenses.</p>
              </div>
              <div>
                <h2 className='font-bold text-gray-800 mb-2'>Refer and Earn</h2>
                <p className='text-gray-600 text-sm'>Refer friends to {storeName} and earn exciting rewards. Share your unique referral code and get discounts on your next course purchase.</p>
              </div>
            </div>
          </div>
          ...
          {/* Similar Stores */}
          <div className='bg-white/80 backdrop-blur-sm shadow-xl rounded-2xl border border-white/20 p-6'>
            <h1 className='text-xl font-bold text-gray-800 mb-4'>Similar Stores</h1>
...
>
  {store}
        ...
        <div className='lg:w-2/3 space-y-6'>
          {/* Header */}
          <div className='bg-white/80 backdrop-blur-sm shadow-xl rounded-2xl border border-white/20 p-6'>
            <h1 className='text-3xl font-bold text-gray-800 mb-2'>{storeName.toUpperCase()} COUPON CODE & DISCOUNTS - NOVEMBER 2025</h1>
            <p className='text-gray-600 mb-4'>{filteredCoupons.length} {storeName} Coupons And Promotional Codes Available For Today</p>
            <div className='flex flex-col lg:flex-row lg:items-center justify-between gap-4'>
              <div className='flex space-x-2'>
                ...
                <button 
                  className={`px-4 py-2 rounded-lg font-medium transition-colors ${
                    activeTab === 'codes' ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
                  }`}
                ...
                <button 
                  className={`px-4 py-2 rounded-lg font-medium transition-colors ${
                    activeTab === 'deals' ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
                  }`}
              ...
              <div className="flex flex-col items-center space-y-1">
                <div className="flex items-center space-x-2 text-yellow-500">
                  ...
                  <div className="flex flex-col -space-y-1">
                    <span className="text-xl font-semibold text-black">{storeRating} / 5</span>
          ...
          <div className='space-y-4'>
            {filteredCoupons.map((coupon) => (
              <div key={coupon.id} className='bg-white/80 backdrop-blur-sm shadow-xl rounded-2xl border border-white/20 p-6'>
                <div className='flex flex-col lg:flex-row lg:items-start justify-between mb-3 gap-3'>
                  <div className='flex items-start space-x-3'>
                    <span className={`${
                      coupon.discount === 'COUPON' ? 'bg-purple-500' : 'bg-red-500'
            ...
            <div className='flex flex-col lg:flex-row items-center gap-6 mb-6'>
              ...
              <div className='lg:w-2/3'>
                <p className='text-gray-700 leading-relaxed mb-4'>
                  Whether you are a recreational boat operator or professional, many countries and states have made it mandatory to have a boat license and insurance to ride legally. The laws and regulations differ from region to region, but license and certification remain the common element. Having a boat driver's license means having enough knowledge to drive a boat. Common prerequisites to owning a boat license include minimum age, good health, etc.
                </p>
                <p className='text-gray-700 leading-relaxed'>
                  {storeName} is a delegated provider of boat courses and boating licenses. Visit www.boated.com to take the state-approved course to complete your online boating safety education. In return, you will get the necessary certificates and licenses to ride and enjoy boating. While at it, apply the {storeName} coupon code available on CouponPin and secure big savings.
                </p>
              </div>
            </div>

            <h2 className='font-bold text-xl text-gray-800 mb-4'>Why is it necessary to take the Boater safety course?</h2>
            <p className='text-gray-700 leading-relaxed'>
              Millions of people enjoy riverside, ocean, and lake boating for recreational reasons. Nothing quite compares to a day out on a boat. Whether it may be a family tradition, part of the exercise, or sports, boating will make you forget the phone. But, the excitement is a twin of risk. There are potential risks while operating a boat as it is not a complete safe task. Hence, it is a big responsibility of the passengers and the boat operator to be educated about boat safety practices.
            </p>
            <p className='text-gray-700 leading-relaxed mt-4'>
              If you are a beginner, a boating certificate or education course is a great first step to preparing for life in water. Wondering where I can get my boat safety education? {storeName} has what you are looking for. It provides online and practical education courses, which you can complete at your own pace in the comfort of your home. Each Indian state has different laws and regulations. The platform has state-specific boating safety courses for recreational boaters of all ages. Visit www.boat-ed.com to learn more about your state's rules and regulations.
            </p>
          </div>
      ...
      {popup && selectedCoupon && selectedCoupon.type === 'code' && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/40 backdrop-blur-sm z-50 p-4">
          <div className="overflow-y-auto h-96 relative bg-white rounded-3xl shadow-2xl w-full max-w-2xl p-8">
      ...
      height={48}
            ...
            {/* Large Code Box */}
            <div className="bg-gradient-to-b from-blue-50 to-blue-100 p-6 rounded-2xl border border-blue-200 shadow-inner">
