    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8 lg:py-10">
        <div className="space-y-8 md:space-y-10 lg:space-y-14">
          {/* HERO SECTION */}
          <div className="bg-white p-6 md:p-8 lg:p-10 rounded-2xl md:rounded-3xl shadow-lg md:shadow-xl">
          ...
          {/* COUPONS SECTION */}
          <div className="bg-white rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 shadow-lg md:shadow-xl">
