...
const FestivalsCoupons = () => {
  ...
  return (
    <div className="relative overflow-hidden lg:ml-20 lg:mr-20 my-10">
      {/* Background Decorative Elements */}
      <div className="absolute -top-20 -right-20 w-64 h-64 bg-linear-to-r from-orange-100 to-pink-100 rounded-full blur-3xl opacity-30"></div>
      <div className="absolute -bottom-20 -left-20 w-64 h-64 bg-linear-to-r from-blue-100 to-cyan-100 rounded-full blur-3xl opacity-30"></div>
      
      <div className="relative p-4 xs:p-5 sm:p-6 md:p-7 lg:p-8 bg-white/80 backdrop-blur-sm rounded-2xl sm:rounded-3xl lg:rounded-4xl shadow-lg sm:shadow-xl lg:shadow-2xl border border-white/60 mx-2 sm:mx-4 md:mx-6 lg:mx-8 xl:mx-auto max-w-6xl">
        
        {/* Header Section */}
        <div className="mb-6 sm:mb-8 md:mb-10 lg:mb-12 text-center relative">
          {/* Decorative Element */}
          <div className="absolute -top-4 -left-4 w-8 h-8 sm:w-12 sm:h-12 bg-linear-to-r from-orange-400 to-pink-400 rounded-full opacity-20"></div>
          <div className="absolute -bottom-4 -right-4 w-8 h-8 sm:w-12 sm:h-12 bg-linear-to-r from-blue-400 to-cyan-400 rounded-full opacity-20"></div>
          
          <div className="inline-flex items-center justify-center gap-3 sm:gap-4 mb-3 sm:mb-4 bg-linear-to-r from-orange-100 to-pink-100 px-4 sm:px-6 py-2 sm:py-3 rounded-full">
            <span className="text-2xl sm:text-3xl md:text-4xl animate-pulse">🎊</span>
            <h2 className="text-lg xs:text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold bg-linear-to-r from-orange-600 via-pink-600 to-purple-600 bg-clip-text text-transparent">
              Festival Offers
            </h2>
            <span className="text-2xl sm:text-3xl md:text-4xl animate-pulse">🎊</span>
          </div>
          
          <p className="text-gray-600 text-sm xs:text-base sm:text-lg md:text-xl max-w-2xl mx-auto">
        ...
        {/* Coupons Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 sm:gap-5 md:gap-6 mb-8 sm:mb-10 md:mb-12 slideFromRight">
        ...
        <div className="relative mb-8 sm:mb-10 md:mb-12 overflow-hidden rounded-2xl sm:rounded-3xl">
          ...
          {/* Dot pattern overlay - Simplified */}
